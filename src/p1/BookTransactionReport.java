...
package p1;
import java.sql.*;
public class BookTransactionReport extends javax.swing.JFrame {

       public BookTransactionReport() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setBackground(new java.awt.Color(195, 234, 212));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Stuname", "Class", "Rollno", "BookId", "Book Name", "AccNo", "Author", "Publisher", "Date", "Status"
            }
        ) {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/p1/v1.jpg"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/p1/b1.jpg"))); // NOI18N
...
jLabel1.setText(e.getMessage());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookTransactionReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookTransactionReport().setVisible(true);
            }
        });
    }
