...
jComboBox1.setSelectedIndex(0);
    ...
    private void initComponents() {
        ...
        jTextField3.setToolTipText("Enter Numeric value");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "BA-I", "BA-II", "BA-III", "BCA-I", "BCA-II", "BCA-III", "BBA-I", "BBA-II", "BBA-III", "MA PUN-I", "MA PUN-II", "MSC-IT-I", "MSC-IT-II", "Item 4" }));
        ...
        jLabel9.setText("Accession no");

        jTextField6.setToolTipText("Enter Numeric value");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/p1/i2.jpg"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/p1/b2.jpg"))); // NOI18N
        ...
        jInternalFrame2Layout.setHorizontalGroup(
            ...
            .addGroup(jInternalFrame2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel11, javax.swing.GroupLayout.DEFAULT_SIZE, 506, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Id", "Bookname", "Author", "Publisher", "Accno"
            }
        ) {
        ...
        jButton3.setText("Check Available Books");
...
String s="insert into transaction values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','Issued')";
String ib="insert into issuebok values  ('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','Issued')";
String ss="update Bookinfo set Status='Issued' where BookID="+s4+"";
st.executeUpdate(s);
st.executeUpdate(ss);
st.executeUpdate(ib);
st.close();
...
ResultSet rs=null;
String s;
s="select BookID,Bookname,Author,Publisher,Accno from Bookinfo where Status='Available'";
...
{
System.out.println("in 3"+e.getMessage());
}  
